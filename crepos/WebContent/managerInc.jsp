        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					<li class="manager">
					    <a class="manager navbar-brand" href="<%=request.getContextPath()%>/controller?actionCode=getSubEmployeeTree">Manager</a>
					</li>
                    <li class="profile">
                    ...
                    <li class="requestApprove">
                        <a href="<%=request.getContextPath()%>/controller?actionCode=getRequestLeaveManger">Approve/ Reject Request Leave</a>
                    </li>
                    <li class="subEmployees">
                    	<a href="<%=request.getContextPath()%>/controller?actionCode=getSubEmployees">Sub Employees</a>
                    </li>
