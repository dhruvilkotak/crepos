...
<%if(request.getSession().getAttribute("role")!=null && !request.getSession().getAttribute("role").equals("manager"))
	{
...
<body>
	...
	<%if(request.getAttribute("employeeList")!=null && request.getAttribute("registerList")!=null )
		...
		List<Register> registerList=(List<Register>) request.getAttribute("registerList");
			...
			<input type="hidden" name="actionCode" value="assignBonus">
			<input type="hidden" name="index" value="<%=i%>">
		          ...
		          <%}
					...
					<td>
					<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#<%= registerList.get(i).getEmployeeId()%>">Assign Bonus</button>
					  <!-- Modal -->
						  <div class="modal fade" id="<%= registerList.get(i).getEmployeeId()%>" role="dialog">
						    <div class="modal-dialog">
						      ...
						      <div class="modal-content" style="width: 200%;margin-left: -50%;">
						          ...
						          <table class="table">
										...
										<tbody>
											...
											<td>
												<div class="form-group">
										            <div class="col-lg-8">
										            <input type="hidden" name="subEmployeeId" value="<%= employeeList.get(i).getEmployeeId()%>">
													<input type="hidden" name="bonus" value="<%= employeeList.get(i).getBonus()%>">
													<input class="form-control" type="text" name="addBonus"  required>
													 </div>
										          </div>
											</td>
						        ...
						        <button type="submit" class="btn btn-info">Assign Bonus</button>
