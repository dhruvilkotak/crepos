		...
		List<LeaveRequest> leaveRequest=(List<LeaveRequest>) request.getAttribute("leaveRequestList");
			...
			{%>
			  <form action="<%=request.getContextPath()%>/controller" method="post" >
				 ...
				 <input type="hidden" name="requestId" value="<%= obj.getRequestId() %>">
    			<tr>
				...
				<td>
				   <button type="submit" class="btn btn-info">Update Employee Request Leave</button>
				</td>
			</tr>
			</form>
			<%}
...
<!--    datepicker end -->
	<script>
	  $(document).ready(function () {
          $('.requestApprove').addClass('active');
         });
	</script>
</body>
